...
output_path = project_root / "outputs/figures/prices_and_residual_load_error.png"
...
axes[0].plot(
    data["time"],
    data["price_da_eur_mwh"],
    label="Day-ahead price",
    color="black",
)
axes[0].plot(
    data["time"],
    data["price_imbalance_long_eur_mwh"],
    label="Long imbalance price",
)
axes[0].plot(
    data["time"],
    data["price_imbalance_short_eur_mwh"],
    label="Short imbalance price",
    linestyle="--",
)
axes[0].set_title("NL day-ahead and imbalance prices")
