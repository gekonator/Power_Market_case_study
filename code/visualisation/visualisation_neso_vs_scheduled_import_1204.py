...
output_path = (
    project_root
    / "outputs/figures/neso_vs_da_britned_import_1204_16_19.png"
)

publication_time = "12:04:00"
delivery_hours = ["16:00:00", "17:00:00", "18:00:00"]
...
neso_bars = ax.bar(
    ...
    color="tab:red",
    alpha=0.8,
    label="NESO BritNed Buy for GB, published 12:04",
)
...
ax.set_title(
    ...
    "NESO disclosure at 12:04:00 UTC"
)
