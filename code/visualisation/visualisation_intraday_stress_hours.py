...
output_path = project_root / "outputs/figures/intraday_prices_stress_hours.png"
...
# Both sides of an execution can be logged as separate rows with the
# same trade_id. Keep one row per execution before calculating medians.
...
fig.suptitle(
    "NL intraday repricing of stress-hour products",
    fontsize=14,
    y=1.0,
)
fig.tight_layout()
