...
ax.plot(
    nl_market_15m["time"],
    nl_market_15m["wind_da_mw"],
    label="Day-ahead forecast",
)

ax.plot(
    nl_market_15m["time"],
    nl_market_15m["wind_actual_total_mw"],
    label="Actual",
)

ax.set_title("NL wind generation: day-ahead forecast vs actual")
...
fig.savefig(
    output_directory / "wind_da_vs_actual.png",
    dpi=150,
    bbox_inches="tight",
)
